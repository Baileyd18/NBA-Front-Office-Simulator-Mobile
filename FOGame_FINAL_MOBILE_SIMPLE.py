...
with left:
    ...
    st.markdown(
        ...
        <div class="mobile-draft-panel">
            ...
            <div class="mobile-draft-copy">Search a player, choose the roster slot, and add them. No spreadsheet needed on mobile.</div>
        </div>
        """,
        unsafe_allow_html=True
    )
        ...
        st.markdown(
            ...
            <div class="mobile-player-preview">
                ...
                <div class="mobile-player-meta">
                    {selected_player_preview['Team']} | {selected_player_preview['Pos']} | {money(selected_player_preview['Salary'])}<br>
                    {selected_player_preview['PPG']:.1f} PPG | {selected_player_preview['APG']:.1f} APG | {selected_player_preview['RPG']:.1f} RPG |
                    3P% {pct(selected_player_preview['3P%'])} | TS% {pct(selected_player_preview['TS%'])}
                </div>
            </div>
            """,
            unsafe_allow_html=True
    ...
    st.markdown('<div class="desktop-draft-board">', unsafe_allow_html=True)

    st.markdown(
        '<div class="draft-board-note">Desktop draft board: box-score production, salary, and shooting splits.</div>',
        unsafe_allow_html=True
    )

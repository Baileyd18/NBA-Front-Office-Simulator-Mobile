...
PRESET_ROSTERS = {
    "Current Thunder": [
        ...
        ("Starting SG", "Jalen Williams"),
        ("Starting SF", "Luguentz Dort"),
        ("Starting PF", "Chet Holmgren"),
        ("Starting C", "Isaiah Hartenstein"),
        ("6th Man", "Alex Caruso"),
        ("Bench 1", "Cason Wallace"),
        ("Bench 2", "Isaiah Joe"),
        ("Bench 3", "Aaron Wiggins"),
        ("Bench 4", "Jaylin Williams"),
        ("Bench 5", "Ajay Mitchell"),
        ("Two-Way 1", "Nikola Topic"),
        ("Two-Way 2", "Ousmane Dieng"),
        ("Bench 6", "Dillon Jones"),
        ("Bench 7", "Kenrich Williams"),
    ],
    "Current Heat": [
        ("Starting PG", "Davion Mitchell"),
        ("Starting SG", "Norman Powell"),
        ("Starting SF", "Andrew Wiggins"),
        ("Starting PF", "Bam Adebayo"),
        ("Starting C", "Kel'el Ware"),
        ("6th Man", "Jaime Jaquez Jr."),
        ("Bench 1", "Tyler Herro"),
        ("Bench 2", "Pelle Larsson"),
        ("Bench 3", "Simone Fontecchio"),
        ("Bench 4", "Kasparas Jakučionis"),
        ("Bench 5", "Dru Smith"),
        ("Two-Way 1", "Nikola Jović"),
        ("Two-Way 2", "Keshad Johnson"),
        ("Bench 6", "Terry Rozier"),
        ("Bench 7", "Alec Burks"),
    ],
    "Current Celtics": [
        ("Starting PG", "Payton Pritchard"),
        ("Starting SG", "Derrick White"),
        ("Starting SF", "Jaylen Brown"),
        ("Starting PF", "Jayson Tatum"),
        ("Starting C", "Kristaps Porziņģis"),
        ("6th Man", "Sam Hauser"),
        ("Bench 1", "Anfernee Simons"),
        ("Bench 2", "Neemias Queta"),
        ("Bench 3", "Luke Kornet"),
        ("Bench 4", "Xavier Tillman Sr."),
        ("Bench 5", "Jordan Walsh"),
        ("Two-Way 1", "Baylor Scheierman"),
        ("Two-Way 2", "JD Davison"),
        ("Bench 6", "Al Horford"),
        ("Bench 7", "Jrue Holiday"),
    ],
    "Current Nuggets": [
        ...
        ("Starting C", "Nikola Jokić"),
        ("6th Man", "Bruce Brown"),
        ("Bench 1", "Julian Strawther"),
        ("Bench 2", "Peyton Watson"),
        ("Bench 3", "Dario Šarić"),
        ("Bench 4", "Jalen Pickett"),
        ("Bench 5", "Zeke Nnaji"),
        ("Two-Way 1", "Hunter Tyson"),
        ("Two-Way 2", "DaRon Holmes II"),
        ("Bench 6", "Spencer Jones"),
        ("Bench 7", "Trey Alexander"),
    ],
    "Current Knicks": [
        ("Starting PG", "Jalen Brunson"),
        ("Starting SG", "Josh Hart"),
        ("Starting SF", "OG Anunoby"),
        ("Starting PF", "Mikal Bridges"),
        ("Starting C", "Karl-Anthony Towns"),
        ("6th Man", "Miles McBride"),
        ("Bench 1", "Mitchell Robinson"),
        ("Bench 2", "Precious Achiuwa"),
        ("Bench 3", "Landry Shamet"),
        ("Bench 4", "Tyler Kolek"),
        ("Bench 5", "Pacôme Dadiet"),
        ("Two-Way 1", "Ariel Hukporti"),
        ("Two-Way 2", "Kevin McCullar Jr."),
        ("Bench 6", "Cameron Payne"),
        ("Bench 7", "Delon Wright"),
    ],
    "Current Timberwolves": [
        ...
        ("6th Man", "Naz Reid"),
        ("Bench 1", "Donte DiVincenzo"),
        ("Bench 2", "Nickeil Alexander-Walker"),
        ("Bench 3", "Rob Dillingham"),
        ("Bench 4", "Terrence Shannon Jr."),
        ("Bench 5", "Joe Ingles"),
        ("Two-Way 1", "Josh Minott"),
        ("Two-Way 2", "Luka Garza"),
        ("Bench 6", "Jaylen Clark"),
        ("Bench 7", "Leonard Miller"),
    ],
    "Current Cavaliers": [
        ...
        ("Bench 2", "Isaac Okoro"),
        ("Bench 3", "Sam Merrill"),
        ("Bench 4", "Georges Niang"),
        ("Bench 5", "Ty Jerome"),
        ("Two-Way 1", "Craig Porter Jr."),
        ("Two-Way 2", "Jaylon Tyson"),
        ("Bench 6", "Tristan Thompson"),
        ("Bench 7", "Emoni Bates"),
    ],
    "Current Magic": [
        ...
        ("6th Man", "Cole Anthony"),
        ("Bench 1", "Anthony Black"),
        ("Bench 2", "Jonathan Isaac"),
        ("Bench 3", "Goga Bitadze"),
        ("Bench 4", "Moritz Wagner"),
        ("Bench 5", "Jett Howard"),
        ("Two-Way 1", "Tristan da Silva"),
        ("Two-Way 2", "Caleb Houstan"),
        ("Bench 6", "Gary Harris"),
        ("Bench 7", "Cory Joseph"),
    ],
    "Superteam Demo": [
        ...
        ("Bench 1", "Trey Murphy III"),
        ("Bench 2", "Isaiah Hartenstein"),
        ("Bench 3", "Naz Reid"),
        ("Bench 4", "Donovan Mitchell"),
        ("Bench 5", "Kawhi Leonard"),
        ("Two-Way 1", "Alex Caruso"),
        ("Two-Way 2", "Chet Holmgren"),
        ("Bench 6", "Giannis Antetokounmpo"),
        ("Bench 7", "Victor Wembanyama"),
    ],
}
...
with st.sidebar:
    ...
    active_roster_slots = ROSTER_SLOTS[:roster_size]
